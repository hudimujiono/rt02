    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link p-4" href="#">Perizinan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link p-4" href="#">Transaksi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link p-4" href="#">Laporan</a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link p-4" href="{{ route('member') }}">
                Member</a>
          </li>
